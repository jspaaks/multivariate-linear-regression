...
void plot_residuals (PLCHAR_VECTOR device, const Matrix * iterations, const Matrix * mean_squared_residuals, size_t niters, size_t ni) {

    PLFLT_VECTOR x = create_x(iterations, niters);
    PLFLT_VECTOR y = create_y(mean_squared_residuals, niters);
